...
import ws2022.Client.Model.Player;
  ...
  /*This class specifies and gives to several scenes the posibility to play a short tune when pressing 
   *a button. 
   *These methods has this class: enterProfile1, goToProfile2, enterGame and displayProfile.
   *These methods are used for adding some sound and specifying name and age of the user. 
   *The method "displayProfile" shows the name and age of the user when playing the game!
   */
